...
- Registry publication: version `1.0.0` published on 2026-09-20. The node is active and the version was pending the Registry's scan at last verification; current Manager includes both active and pending versions.
